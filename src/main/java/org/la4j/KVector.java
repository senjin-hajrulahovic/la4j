 ...
 */
public abstract class KVector implements Iterable<Double> {
     ...
     */
    public boolean equals(KVector that, double precision) {
        if (this == that) {
            return true;
        }
    ...
    public boolean equals(Object o) {
        return o != null && (o instanceof Vector) && equals((KVector) o, Vectors.EPS);
    }
    ...
    public VectorIterator iterator() {
        return new VectorIterator(length) {
            ...
            @Override
            public double get() {
                return KVector.this.get(i);
            }

            @Override
            public void set(double value) {
                KVector.this.set(i, value);
            }
